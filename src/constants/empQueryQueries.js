module.exports = {
  ...
  GROUP BY 
    t.id, t.sender_id, e.first_name, e.last_name, t.recipient_id, t.department_id, 
    t.status, t.subject, t.latest_message, t.feedback, t.note, t.created_at, t.updated_at
  ORDER BY 
    t.updated_at DESC;
  `,
