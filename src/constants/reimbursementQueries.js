...
UPDATE_REIMBURSEMENT_STATUS: `
  UPDATE reimbursement
  SET status = ?, approver_comments = ?, approver_id = ?, approver_name = ?, approver_designation = ?, approved_date = ?
  WHERE id = ?
`,
...
GET_EMPLOYEE_DETAILS: `SELECT CONCAT(e.first_name, " ", e.last_name) AS name, e.position, d.name AS department_name
FROM employees e
